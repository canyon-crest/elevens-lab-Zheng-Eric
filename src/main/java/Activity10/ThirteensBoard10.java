...
public class ThirteensBoard10 extends Board10 {
     ...
     * (1) a pair of cards whose values add to 13, or (2) a single king.
     ...
     * @return true if the board entries in selectedCards contain a 13-pair; false otherwise.
     */
    ...
    /**
     * Check for a single king in the selected cards.
     * @param selectedCards selects a subset of this board.
     * @return true if the selected card is a king; false otherwise.
     */
